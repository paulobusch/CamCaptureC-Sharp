...
namespace MultiCam.Controller
{
    ...
    public class AppController : EntityBase, IAppController
    {
        ...
        /// components and Run user interface
        /// </summary>
        /// <param name="contextApplication">Implementation IContextApplication</param>
        public AppController()
        {
            //Dependêncies
            _notify = RegServices.Ioc.Get<INotifyController>();
            _config = RegServices.Ioc.Get<IConfigController>();
            _about = RegServices.Ioc.Get<IAboutController>();
            _grid = RegServices.Ioc.Get<IGridController>();
            _unit_of_work = RegServices.Ioc.Get<IUnitOfWork>();
        }
        ...
        {
            _unit_of_work.DeviceRepository.Insert(videoCapture);
        ...
        public void SaveDevice(VideoCapture videoCapture)
        {
            ...
            _unit_of_work.DeviceRepository.Update(videoCapture);
        ...
        {
            _unit_of_work.DeviceRepository.Delete(id);
